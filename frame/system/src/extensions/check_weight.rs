	...
	fn check_block_weight(
		...
		match info.class {
			...
			DispatchClass::Normal => {
				...
				debug::info!("extrinsic_weight: {}, total_block_weight: {}, normal_limit: {}, extrinsic_base_weight: \
				{}, dispatch_weight: {}",
					extrinsic_weight, total, normal_limit, T::ExtrinsicBaseWeight::get(), info.weight
				);
